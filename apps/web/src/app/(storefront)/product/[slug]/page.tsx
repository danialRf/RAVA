      ...
      <div className="product-detail">
        ...
        <div className="purchase-column">
            ...
            <PriceUnavailable
              reason={
                rate === null
                  ...
                  : "پیشنهاد فعالی برای این محصول ثبت نشده است."
              }
            />
          )}
          ...
          <p className="buy-note">
            ابتدا قیمت ده‌دقیقه‌ای با نرخ تازه برای شما قفل می‌شود؛ سپس فقط
            پیش‌پرداخت را می‌پردازید.
          </p>
      ...
      <section className="detail-copy">
        ...
        <div>
          ...
          <p>
            ...
            و نرخ ارز ثبت‌شده محاسبه می‌شود. در تسویه یک پیشنهاد قیمت کوتاه‌مدت
            می‌بینید و هیچ مبلغی بدون تأیید شما تغییر نمی‌کند.
          </p>
          {lead?.estimate != null && (
            <>
              <h3>پیش‌پرداخت</h3>
