...
export default async function AdminOffersPage({
  ...
  return (
    <>
      <AdminPageHeader
        eyebrow="تنظیمات پیشرفته محصول"
        title="قیمت و موجودی خرید از آلمان"
        copy="برای هر محصول، فروشگاه، لینک خرید، قیمت یورو و موجودی را ثبت کنید."
      />
      <AdminNotice title="این بخش چه کاری می‌کند؟" tone="info">
        این اطلاعات فقط برای محاسبه قیمت و خرید کالا استفاده می‌شوند. ساخت و
        انتشار خود محصول در صفحه «محصولات» انجام می‌شود.
      </AdminNotice>
